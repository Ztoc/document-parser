...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="border-b border-border py-4 px-12">
        <div className="mx-auto flex justify-between items-center">
          ...
          <a
            href="https://github.com/yourusername/document-parser"
            target="_blank"
      ...
      <main className="flex-1 flex flex-col md:flex-row">
        {/* Left Column */}
        <div className="w-full md:w-1/2 py-6 px-12 border-r border-border">
          <div className="mb-6">
            <h2 className="text-xl font-medium mb-2">Parse OOXML Documents</h2>
          ...
          <div className="mt-12">
            ...
            <p className="text-muted-foreground mb-4">
              This custom OOXML parser accurately replicates document structure
              and numbering without external libraries. It processes Office Open
              XML (exported from Microsoft Word) and displays the content in a
        ...
        {/* Right Column */}
        <div className="w-full md:w-1/2 p-6 flex flex-col flex-1">
          <div className="mb-3">
          ...
          {isLoading ? (
            ...
            <div className="border border-dashed border-border rounded-lg h-full flex-1 flex items-center justify-center">
              <p className="text-muted-foreground">
